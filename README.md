...
例如：
 ...
 <img src=".\for_doc\image\index_block_00.png" alt="index_block_00" style="zoom: 25%;" />

文件 `file_01.txt` 的索引所在 `Block` 为 `Block 1`，用来存放文件内容的 `Blokc` 有 2、3、4、5、6、8、9、0xA

`Block 1` 内容如下

 <img src=".\for_doc\image\index_block_01.png" alt="index_block_01" style="zoom: 25%;" />
...
每次启动程序时询问是否进行格式化
 ...
 <img src=".\for_doc\image\格式化.png" alt="格式化" style="zoom: 25%;" />
...
`create file_name block_count`
 ...
 <img src=".\for_doc\image\create.png" alt="create" style="zoom: 25%;" />
...
`find test1.txt`
 ...
 <img src=".\for_doc\image\find.png" alt="find" style="zoom: 25%;" />
...
`remove test1.txt`
 ...
 <img src=".\for_doc\image\remove.png" alt="create" style="zoom: 25%;" />
...
`truncate test1.txt`
 ...
 <img src=".\for_doc\image\truncate.png" alt="truncate" style="zoom: 25%;" />
...
`increase file_name inc_cout`
 ...
 <img src=".\for_doc\image\increase.png" alt="increase" style="zoom: 25%;" />
...
`write file_name string`
 ...
 <img src=".\for_doc\image\write.png" alt="write" style="zoom: 25%;" />
...
`read file_name size`
 ...
 <img src=".\for_doc\image\read.png" alt="read" style="zoom: 25%;" />
...
`rename test1.txt test1_new.txt`
 ...
 <img src=".\for_doc\image\rename.png" alt="rename" style="zoom: 25%;" />
...
`ls_i`
 ...
 <img src=".\for_doc\image\ls_i.png" alt="ls_i" style="zoom: 25%;" />
...
`ls test1.txt`
 ...
 <img src=".\for_doc\image\ls.png" alt="ls" style="zoom: 25%;" />
